...
#include "ros/ros.h"
#include <webot/ric_raw.h>
#include <webot/ric_gps.h>
#include <webot/ric_pan_tilt.h>
#include <webot/ric_command.h>
#include <webot/set_odom.h>
...
void gpsCallback(const webot::ric_gps::ConstPtr& msg) {
...
void imuCallback(const webot::ric_raw::ConstPtr& msg) {
...
void rawCallback(const webot::ric_raw::ConstPtr& msg) {
...
bool set_odom(webot::set_odom::Request  &req, webot::set_odom::Response &res)
{
...
void pan_tiltCallback(const webot::ric_pan_tilt::ConstPtr& msg) {
...
int main(int argc, char **argv) {
  ...
  command_pub = n.advertise < webot::ric_command > (ric_command_topic, 5);
