...
geometry_msgs::TransformStamped trans_base_link;
            ...
            switch (message.msgid)
                 {
                   case MAVLINK_MSG_ID_ATTITUDE_QUATERNION:
                   {
                	   ...
                	   header.frame_id = "webot_base_link";
                	   ...
                	   if(imu_pub.getNumSubscribers() > 0)
                	      {
                	        ...
                	        imu_msg->orientation.x = att.q1;
                	        imu_msg->orientation.y = att.q2;
                	        imu_msg->orientation.z = att.q3;
                	        imu_msg->orientation.w = att.q4;
                           ...
                           *it = 0;
                           ...
                           trans_base_link.header.frame_id = "webot_odom";
                           trans_base_link.child_frame_id = "webot_tansf_base";
                           ...
                           tf::quaternionTFToMsg(tf::createQuaternionFromRPY(3.14159,0,0), q_msg);
                           trans_base_link.transform.rotation  = q_msg;
                           //send the transform
                   ...
                   case MAVLINK_MSG_ID_COMMAND_LONG:
                   {
                	   ...
                	   trans_odom.header.frame_id = "map";
                	   trans_odom.child_frame_id = "webot_odom";
                	   trans_odom.transform.translation.x = 0.0;
                	   trans_odom.transform.translation.y = 0.0;
                	   trans_odom.transform.translation.z = 0.0;
                	   trans_odom.transform.rotation = tf::createQuaternionMsgFromYaw(0);;
				       //send the transform
                	   ...
                	   //next, we'll publish the odometry message over ROS
                           ...
                           odom.child_frame_id = "webot_odom";
                           att.q1;
...
// SETUP SERIAL PORT
  ...
  if (fd == -1)
      ...
      ros::NodeHandle webot_bridge("/bridge");
      ros::NodeHandle webot_link("/bridge");
      ros::NodeHandle webot_imu("/bridge");
      ros::NodeHandle webot_pcl("/bridge");
      pcl_pub = webot_pcl.advertise<sensor_msgs::PointCloud2>("barrier_pcl", 1);
      imu_pub = webot_imu.advertise<sensor_msgs::Imu>("imu", 10);
      bridge_odom_pub = webot_bridge.advertise<nav_msgs::Odometry>("odom", 50);
      ros::Subscriber sub = webot_link.subscribe("/cmd_vel", 1000, callback);
